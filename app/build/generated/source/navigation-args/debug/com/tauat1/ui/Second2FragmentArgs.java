...
public class Second2FragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private Second2FragmentArgs() {
  }

  private Second2FragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static Second2FragmentArgs fromBundle(@NonNull Bundle bundle) {
    Second2FragmentArgs __result = new Second2FragmentArgs();
    bundle.setClassLoader(Second2FragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    Second2FragmentArgs that = (Second2FragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(Second2FragmentArgs original) {
    ...
    @NonNull
    public Second2FragmentArgs build() {
      Second2FragmentArgs result = new Second2FragmentArgs(arguments);
      return result;
    }
